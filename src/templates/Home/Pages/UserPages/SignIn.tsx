    ...
    <Fragment>
      {_.isEmpty(userSignIn) && (
        ...
        >
            ...
            <form onSubmit={formik.handleSubmit}>
              <div>
                ...
                <input
                  ...
                  className="w-full text-base lg:text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-purple-500"
                />
          ...
          <p className="mt-4 mb-8 lg:my-8 text-center text-sm lg:text-base text-gray-500 "></p>
        </div>
      )}
    </Fragment>
  );
